...
OPS = {
    'skip_connect': lambda Cin,Cout, stride, signal: (layer.Conv2d(Cin, Cout, stride=stride, padding=1) if signal == 1 else Identity(Cin, Cout, signal)),
    'snn_b3': lambda Cin,Cout, stride, signal: layer.Conv2d(Cin, Cout, kernel_size=3, stride=stride, padding=1),
    'snn_b5': lambda Cin,Cout, stride, signal: layer.Conv2d(Cin, Cout, kernel_size=3, stride=stride, padding=1)
}
