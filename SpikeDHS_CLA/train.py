...
if fitlog_debug:
    ...
    args.save = os.path.join(log_path,fitlog.get_log_folder())
...
def main():
  ...
  model.load_state_dict(torch.load('/home/hanjing/CHE/SpikeDHS_CLA/logs/log_20230105_165556/weights.pt'), strict=True)
